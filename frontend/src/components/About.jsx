        ...
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-x-16 lg:items-center">
          ...
          <div className="flex flex-col justify-center max-w-2xl">
            ...
            <p className="text-lg leading-relaxed text-[#6B7280] mb-6">
              At BlueDoorHomes, we believe that finding your dream property
              should be an exciting and seamless journey. With years of
              experience and a deep understanding of the premium real estate
              market, we connect visionary buyers with exceptional properties.
            </p>
            <p className="text-lg leading-relaxed text-[#6B7280] mb-10">
              Our curated portfolio features exclusive lands, luxury homes, and
              prime commercial spaces. Whether you're a first-time homebuyer, a
              seasoned investor, or seeking the perfect commercial plot, our
              dedicated team is committed to providing expert guidance and
