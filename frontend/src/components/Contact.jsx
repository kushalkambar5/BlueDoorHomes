        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col lg:flex-row border border-gray-100">
          ...
          <div className="lg:w-2/5 bg-[#0F172A] text-white p-10 flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="space-y-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:+919999999999" className="text-lg hover:text-[#C9A227] transition-colors">+91 99999 99999</a>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@bluedoorhomes.com" className="text-lg hover:text-[#C9A227] transition-colors break-all">contact@bluedoorhomes.com</a>
                  </div>
                </div>
            ...
            <div className="mt-16 flex gap-4">
              <a href="#" className="h-10 w-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-[#C9A227] hover:text-[#0F172A] transition-all duration-300">
