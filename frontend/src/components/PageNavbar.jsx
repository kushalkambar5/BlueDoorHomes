    ...
    <nav className="sticky top-0 z-50 w-full transition-all duration-300 border-b border-white/5 bg-[#0F172A]/90 backdrop-blur-md px-4 py-4 shadow-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            to="/"
            className="hidden sm:flex items-center gap-2 whitespace-nowrap text-xl font-extrabold tracking-tight text-white transition-all hover:text-[#C9A227] group"
          >
            <svg 
              xmlns="http://www.w3.org/2000/svg" 
              className="h-6 w-6 text-[#C9A227] group-hover:scale-110 transition-transform" 
              fill="none" 
              viewBox="0 0 24 24" 
              stroke="currentColor"
            >
