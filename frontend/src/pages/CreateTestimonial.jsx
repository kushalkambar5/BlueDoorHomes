...
function CreateTestimonial() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <PageNavbar title="Add Testimonial" />
      
      <div className="container mx-auto px-4 py-8 max-w-2xl flex-grow">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
            <h2 className="text-2xl font-bold text-primary mb-6">Create New Testimonial</h2>
            ...
            <div className="flex flex-col items-center mb-6">
               ...
               <p className="text-xs text-gray-500 mt-2 font-medium">Click to upload client photo</p>
            </div>
